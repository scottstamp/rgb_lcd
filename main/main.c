...
/* LCD pins */
#define EXAMPLE_LCD_GPIO_VSYNC     (GPIO_NUM_39)
#define EXAMPLE_LCD_GPIO_HSYNC     (GPIO_NUM_41)
...
/* Backlight pin */
#define EXAMPLE_LCD_BACKLIGHT       (GPIO_NUM_2)
...
static esp_err_t app_lcd_init(void)
{
    ...
    esp_lcd_rgb_panel_config_t panel_conf = {
        ...
        .timings = EXAMPLE_LCD_PANEL_25HZ_RGB_TIMING(),
        .flags.fb_in_psram = 1,
...
static void app_init_lcd_backlight(void) {
#if EXAMPLE_LCD_BACKLIGHT >= 0
	gpio_config_t bk_gpio_config = {.mode = GPIO_MODE_OUTPUT,
									.pin_bit_mask =
										1ULL << EXAMPLE_LCD_BACKLIGHT};
	ESP_ERROR_CHECK(gpio_config(&bk_gpio_config));
#endif
}

static void app_set_lcd_backlight(uint32_t level) {
#if EXAMPLE_LCD_BACKLIGHT >= 0
	gpio_set_level(EXAMPLE_LCD_BACKLIGHT, level);
#endif
}
...
void app_main(void)
{
    ...
    app_init_lcd_backlight();
    app_set_lcd_backlight(0);
